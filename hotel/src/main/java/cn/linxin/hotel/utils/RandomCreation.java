...
public class RandomCreation {
    ...
    private static String getId() {
        ...
        String first=telFirst[index];
        String second=String.valueOf(getNum(1,888)+10000).substring(1);
        String second2=String.valueOf(getNum(1,888)+10000).substring(1);
        String thrid=telFirst[index];
        String thrid2=String.valueOf(getNum(1,888)+10000).substring(1);
        return first+second+ second2+thrid+thrid2;
    }
